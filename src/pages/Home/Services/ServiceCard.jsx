...
const ServiceCard = ({ icon, titleKey, descriptionKey }) => {
    ...
    return (
        ...
        hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 text-center
         hover:bg-[#e0eaf1]">
            ...
            {/* Title */}
            <h3 className="text-lg text-blue-950 font-semibold mb-2">{t(titleKey)}</h3>

            {/* Description */}
            <p className="text-gray-600 dark:text-gray-500 text-sm">{t(descriptionKey)}</p>
        </div>
    );
};
