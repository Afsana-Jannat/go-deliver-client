            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    if (res.data.insertedId) {
                        ...
                        const trackingData = {
                            tracking_id: trackingID,
                            parcel_id: res.data.insertedId,
                            status: "not_collected",
                            message: "Parcel created, waiting for pickup",
                            updated_by: user.email
                        };

                        await axiosSecure.post("/trackings", trackingData);

                        Swal.fire("✅ Success!", "Parcel and tracking info saved successfully!", "success");
                        navigate("/dashBoard/myParcels");
                    }
                } catch (err) {
                    console.error("Error saving parcel or tracking info:", err);
